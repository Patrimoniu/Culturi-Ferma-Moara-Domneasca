...
function exp_label_Cultura20152016_1_eval_expression(context) {
    // "2015_2016" || '\n' || Suprafata || ' ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return (((feature.get('2015_2016')  + '\n') + feature.get('Suprafata') ) + ' ha');
    } else {
        return (((feature.get('2015_2016')  + '\n') + feature.get('Suprafata') ) + ' ha');
    }
}
...
function exp_label_Cultura20222023_2_eval_expression(context) {
    // culturi || '\n' || Suprafata || ' ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return (((feature.get('culturi')  + '\n') + feature.get('Suprafata') ) + ' ha');
    } else {
        return (((feature.get('culturi')  + '\n') + feature.get('Suprafata') ) + ' ha');
    }
}
...
function exp_label_Cultura20232024_3_eval_expression(context) {
    // Cult_23_24 || '\n' || Suprafata || ' ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return (((feature.get('Cult_23_24')  + '\n') + feature.get('Suprafata') ) + ' ha');
    } else {
        return (((feature.get('Cult_23_24')  + '\n') + feature.get('Suprafata') ) + ' ha');
    }
}
...
function exp_label_Cultura20242025_4_eval_expression(context) {
    // Cult_24_25 || '\n' || Suprafata || ' ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return (((feature.get('Cult_24_25')  + '\n') + feature.get('Suprafata') ) + ' ha');
    } else {
        return (((feature.get('Cult_24_25')  + '\n') + feature.get('Suprafata') ) + ' ha');
    }
}
...
function exp_label_Cultura20252026_5_eval_expression(context) {
    // Cult_25_26 || '\n' || Suprafata || ' ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return (((feature.get('Cult_25_26')  + '\n') + feature.get('Suprafata') ) + ' ha');
    } else {
        return (((feature.get('Cult_25_26')  + '\n') + feature.get('Suprafata') ) + ' ha');
    }
}